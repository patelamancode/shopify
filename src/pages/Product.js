...
const Product = () => {
    ...
    return (
        <> {
            selectedItem.map(item => <section className="text-gray-600 body-font overflow-hidden"
                key={
                    item.id
            }>
                <div className="container px-5 py-24 mx-auto">
                    <div className="lg:w-4/5 mx-auto flex flex-wrap">
                        <img alt="ecommerce" className="lg:w-1/2 w-full lg:h-auto max-h-64 object-contain object-center rounded align-center"
                            src={
                                item.image
                            }/>
