        ...
        <header className="text-gray-600 body-font shadow">
            <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
                ...
                <nav className="md:ml-auto flex flex-wrap items-center text-base justify-center">
                    ...
                    <NavLink NavLink to="/cart" className="mr-5 hover:text-gray-900">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                            strokeWidth={1.5}
                            stroke="currentColor"
                            className="w-6 h-6">
                    ...
                    <NavLink NavLink to="/wishlist" className="mr-5 hover:text-gray-900">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                            strokeWidth={1.5}
                            stroke="currentColor"
                            className="w-6 h-6">
                ...
                {/* <button className="inline-flex items-center bg-gray-100 border-0 py-1 px-6 focus:outline-none hover:bg-blue-200 rounded text-base mt-4 md:mt-0">Go to Cart
